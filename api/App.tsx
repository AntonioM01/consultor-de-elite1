  ...
  useEffect(() => {
    const initBot = async () => {
      ...
      try {
        ...
        console.error('Erro initBot:', err);
        setMessages([{
          id: Date.now().toString(),
          sender: Sender.BOT,
          text: 'Desculpe, houve um erro ao inicializar o consultor.',
          timestamp: new Date()
        }]);
      } finally {
        setIsTyping(false);
          ...
          <div className="space-y-8">
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Nas configurações da Vercel (Environment Variables), adicione a chave <code className="bg-gray-100 px-1 rounded text-orange-600">API_KEY</code>.</p>
